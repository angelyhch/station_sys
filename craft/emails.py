...
def send_mail_self():
    ...
    def build_message():
        ...
        message_content = ''''''
        message_content += f'<h2>今日关注共<strong>{counts}</strong>项</h2>'
...
def run_apscheduler():
    ...
    try:
        ...
        scheduler.add_job(send_mail_self, 'cron', hour='13', minute='15', id='send_mail_everyday',replace_existing=True)
        scheduler.start()
